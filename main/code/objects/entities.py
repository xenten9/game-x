...
class ObjMainMenu(Entity):
    def __init__(self, engine: Engine, key: int, name: str, data: dict):
        ...
        # OPTION BUTTON
        option_button = MenuButtonFull(
            engine, self.title_menu, "option-button"
        )
        ...
        # RETURN Button
        return_button = MenuButtonFull(
            engine, self.option_menu, "return-button"
        )
